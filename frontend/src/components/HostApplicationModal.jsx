...
export const WishlistHeart = ({ listingId, initialIsWishlisted }) => {
  const [liked, setLiked] = React.useState(initialIsWishlisted);
  ...
  const toggleWishlist = (e) => {
    ...
    console.log("Wishlist toggled for:", listingId);
  };
...
const ListingDetailModal = ({ isOpen, onClose, selectedListing }) => {
    ...
    <div className="modal-overlay">
      ...
      <div className="modal-content">
        ...
        <div className="modal-images">
          {selectedListing.all_images?.length > 0 ? (
            selectedListing.all_images.map((img, index) => (
              <img
                key={index}
                src={
                  img.startsWith("http")
        ...
        <div className="modal-info">
          ...
          <h3>Rs. {selectedListing.price_per_night} / night</h3>
