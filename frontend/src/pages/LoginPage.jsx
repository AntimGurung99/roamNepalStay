...
export default function LoginPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("access", data.access); // antim added
      localStorage.setItem("refresh", data.refresh); // antim added
      localStorage.setItem("user", JSON.stringify(user)); // antim added
  ...
  return (
    <div className="login-wrapper">
      <form className="login-card" onSubmit={onSubmit}>
        ...
        {errors.general && (
          <div className="login-error-box">{errors.general}</div>
        )}
