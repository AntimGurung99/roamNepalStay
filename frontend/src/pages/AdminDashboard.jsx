...
//               Hi, <strong>{user?.first_name || "Admin"}</strong>
//             </span>
...
//                   <img
//                     src={`http://127.0.0.1:8000${booking.listing_image}`}
...
const handleCityChange = (newCity) => {
  ...
  return (
    <div className="admin-dashboard">
      <header className="admin-header">
        <div className="admin-header-content">
          <div className="admin-brand admin-brand-vertical">
            <img
              src={logo}
              alt="RoamNepalStay Logo"
              className="admin-logo-img"
            />
            <h2 className="admin-brand-name">RoamNepalStay</h2>
          </div>

          <div className="admin-header-center">
            <h1>Welcome to Admin Panel</h1>
            <p className="admin-quote">
              “Great administration builds trust, order, and better experiences.”
            </p>
          </div>
...
const DashboardOverview = ({
  ...
  return (
    <div className="dashboard-overview animate-fade-in">
      <div className="section-header">
        <h2>Analytics And System Overview</h2>
        <p>Real-time analytics across RoamNepalStay ecosystem</p>
      </div>
